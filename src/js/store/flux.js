  ...
  return {
    ...
    actions: {
      ...
      postAgenda: async () => {
        try {
          const response = await fetch(
            "https://playground.4geeks.com/contact/agendas/camila",
            {
              method: "POST",
              headers: {
      ...
      getContact: async () => {
        ...
        try {
          const response = await fetch(
            "https://playground.4geeks.com/contact/agendas/camila/contacts"
          );
      ...
      editContact: async (id, contactEdit) => {
        ...
        try {
          const response = await fetch(
            `https://playground.4geeks.com/contact/agendas/camila/contacts/${id}`,
            {
              method: "PUT",
